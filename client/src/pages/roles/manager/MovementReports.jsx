                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <div className="flex space-x-2">
                        <button onClick={handleSearch} disabled={isLoading}
                            className="flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-md disabled:opacity-50">
                            {isLoading ? 'Searching...' : <><FiSearch className="mr-2" />Search</>}
                        </button>
                        <button onClick={handleClear}
                            className="flex items-center px-4 py-2 border text-sm rounded-md bg-white text-gray-700 hover:bg-gray-50">
