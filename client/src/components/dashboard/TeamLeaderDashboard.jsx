    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-1">Welcome, {userData.Name || 'Team Leader'}!</p>
        </div>
        <button
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl shadow-sm p-6 mb-8 border border-gray-100">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          />
          <InfoCard 
            icon={<GiOfficeChair className="text-blue-600" />} 
            title="Department" 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button 
              onClick={() => navigate('/team/manage-team')}
              className="bg-purple-50 hover:bg-purple-100 text-purple-700 p-3 rounded-lg flex flex-col items-center transition cursor-pointer"
            >
              <HiOutlineUserGroup className="text-lg mb-1" />
              <span className="text-xs font-medium">Team View</span>
            </button>
            <button 
              onClick={() => navigate('/team/team-report')}
              className="bg-green-50 hover:bg-green-100 text-green-700 p-3 rounded-lg flex flex-col items-center transition cursor-pointer"
            >
              <BsGraphUp className="text-lg mb-1" />
